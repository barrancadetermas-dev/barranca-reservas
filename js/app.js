...
// ══════════════════════════════════════════════════
const THEMES = {
  navy:   { primary:'#1a56db', primaryH:'#1443b5', primaryL:'#DDEAFF', primaryT:'rgba(26,86,219,.12)',    sidebarBg:'#0D1F42', sidebarActive:'#1A3472', sidebarAccent:'#60A5FA' },
  slate:  { primary:'#475569', primaryH:'#334155', primaryL:'#F1F5F9', primaryT:'rgba(71,85,105,.12)',    sidebarBg:'#0f172a', sidebarActive:'#1e293b', sidebarAccent:'#94a3b8' },
  teal:   { primary:'#0d9488', primaryH:'#0f766e', primaryL:'#ccfbf1', primaryT:'rgba(13,148,136,.12)',   sidebarBg:'#042f2e', sidebarActive:'#134e4a', sidebarAccent:'#5eead4' },
  ...
  orange: { primary:'#ea580c', primaryH:'#c2410c', primaryL:'#fff7ed', primaryT:'rgba(234,88,12,.12)',    sidebarBg:'#1c0a00', sidebarActive:'#431407', sidebarAccent:'#fdba74' },
};
